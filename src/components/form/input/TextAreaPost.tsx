...
const TextArea: React.FC<TextareaProps> = ({
  ...
  if (disabled) {
    ...
    textareaClasses += ` bg-transparent text-gray-400 border-gray-300 focus:border-[#E6C67A] focus:ring-2 focus:ring-[#E6C67A] dark:border-gray-700 dark:bg-gray-900 dark:text-white/90`;
  }
