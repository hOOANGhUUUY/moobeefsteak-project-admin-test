        ...
        <Table className="min-w-[1000px]">
          <TableHeader>
            <TableRow className="bg-gray-100">
              ...
              <TableCell isHeader className="px-4 py-3 font-medium text-gray-700 w-[80px]">Đặt cọc</TableCell>
                ...
                <TableRow key={order.id} className="hover:bg-gray-50 text-center">
                  ...
                  <TableCell className="px-4 py-3 text-sm text-center">
                    ...
                    {(order as any).tables && (order as any).tables.length > 0 ? (
                      <span
                        /* eslint-disable-next-line @typescript-eslint/no-explicit-any */
                        title={(order as any).tables.map((t: any) => `Bàn số ${t.table_number}`).join(', ')}
                  ...
                  <TableCell className="px-4 py-3 text-sm text-center">
                    {order.status_deposit === 2 ? "Chưa thành toán" : "Đã thành toán"}
                  </TableCell>
                  <TableCell className="px-4 py-3 text-sm">
              ...
              <>
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-6">
                  <div className="space-y-2">
                    ...
                    {/* eslint-disable-next-line @typescript-eslint/no-explicit-any */}
                    <div><span className="font-medium">Bàn đã đặt:</span> {(detailOrder as any).tables && (detailOrder as any).tables.length > 0 ? (detailOrder as any).tables.map((t: any) => `Bàn số ${t.table_number}`).join(', ') : (detailOrder.id_table || "N/A")}</div>
                  </div>
                  <div className="space-y-2">
                    <div><span className="font-medium">Số bàn:</span> {detailOrder.id_table || "N/A"}</div>
                ...
                <div className="mt-6 border-t pt-4">
                  ...
                  <div className="flex justify-between items-center">
                    ...
                    <span className={`px-2 py-1 rounded-full text-xs font-medium ${
                      ...
                      {detailOrder.status_deposit === 2 ? "Chưa thanh toán" : "Đã thanh toán"}
                    </span>
                  </div>
                </div>
